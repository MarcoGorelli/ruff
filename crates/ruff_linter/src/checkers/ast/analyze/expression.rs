...
use crate::rules::{
    ...
    pandas_vet, pep8_naming, polars_vet, pycodestyle, pyflakes, pygrep_hooks, pylint, pyupgrade,
    refurb, ruff,
};
        ...
        Expr::Name(ast::ExprName { id, ctx, range }) => {
            match ctx {
                ExprContext::Load => {
                    ...
                    if checker.enabled(Rule::PolarsDeprecatedFunction) {
                        polars_vet::rules::deprecated_function(checker, expr);
                    }
